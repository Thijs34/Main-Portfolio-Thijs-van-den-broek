    ...
    >
      ...
      <span
        className={`inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg
          bg-slate-950 px-7 text-sm font-medium text-white backdrop-blur-3xl gap-2 transition-all duration-300 group-hover:bg-slate-900 group-hover:scale-[0.98] ${otherClasses}`}
      >
        {position === "left" && icon}
        {title}
        {position === "right" && icon}
